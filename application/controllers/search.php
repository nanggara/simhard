...
class search extends CI_Controller {
	...
	function on_print_pdf(){
		//require('assets/library/fpdf17/mysql_table.php');
		//ob_start();
		
		//require('assets/library/tcpdf/tcpdf.php');
		...
		$this->load->library("FPDF_AutoWrapTable1");
		//$this->load->model('mdl_search','',TRUE);		
		...
		$data_header = $this->mdl_search->form_get_all(false,0,100000,$filter);
		...
		$tabel = new FPDF_AutoWrapTable1($options);
