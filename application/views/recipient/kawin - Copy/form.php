	            	...
	            	<div class="row">
	                	<div class="col-sm-6 b-r">
							...
							<div class="form-group">
	                        	...
	                        	<input type="text" id="txt_kawinmodal" name="txt_kawinmodal" placeholder="Input Status" class="form-control">
	                        </div>                            
	                        <div>
	                    ...
	                    <div class="col-sm-6"> 
	                    	...
	                    	<div class="col-sm-7">
	                            <div class="input-group">
	                            	...
	                            	<button type="button" id="btnSearchkawin" class="btn btn-sm btn-primary" onclick="kawin_search()"> Go!</button> </span>
	                            </div>
	                        </div>
	                        <br><br>
