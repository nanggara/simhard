...
function institusi_save(){ 
    ...
    $.ajax({
 		type: "POST",
 		url : "<?php echo site_url('recipient/institusi_save/')?>",
 		data: data,
...
function institusi_search(){
    ...
    $.ajax({
 		type: "POST",
 		url : "<?php echo site_url('recipient/institusi_pagging/')?>",
 		data: data,
 		success: function(response){ 
 			$('#progressBarinstitusi').hide();
...
function institusi_select_row(kode){  
    ...
    $.ajax({
 		type: "POST",
 		url : "<?php echo site_url('recipient/institusi_select_row/')?>",
 		data: data,
 		success: function(response){ 
 			if(response=='[]'){
...
function institusi_delete_row(kode){  
    ...
    $.ajax({
 		type: "POST",
 		url : "<?php echo site_url('recipient/institusi_delete_row/')?>",
 		data: data,
 		success: function(response){ 
