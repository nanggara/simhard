	 ...
	 <div class="form-group text-left">  
			...
			<div class="col-sm-12"> 
				<div class="form-group"><label class="col-sm-2 control-label">Kelompok</label>
					<div class="col-sm-4">
						<select id="slc_kelompok" name="slc_kelompok" class="form-control">
							<option value="0">SEMUA KELOMPOK</option>
						<?php foreach($ddl_datakelompok->result() as $kelIns) {?>
						    <option value="<?php echo $kelIns->kodekelompok;?>"><?php echo $kelIns->kelompok;?></option> 
						<?php }?>
						</select> 
					</div> 
				</div>  
			...
			<div class="col-sm-12"> 
				<div class="form-group"><label class="col-sm-2 control-label">Universitas</label>
					<div class="col-sm-4">
						<select id="slc_universitas" name="slc_universitas" class="form-control">
							<option value="0">SEMUA UNIVERSITAS</option>
						<?php foreach($ddl_datauniversitas->result() as $kelUni) {?>
						    <option value="<?php echo $kelUni->kodeuniversitas;?>"><?php echo $kelUni->universitas;?></option> 
						<?php }?>
						</select> 
					</div> 
				</div>  
